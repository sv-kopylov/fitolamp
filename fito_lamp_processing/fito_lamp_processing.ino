...
int timeTable[] = { 
  ...
  120, MORNING, // 2*60+0 c 2х утра
  150, DAY, // 2.5*60+0 c 2.30х утра
  810,EVENING, // 12*60 + 30 до 12:30 вечера
  840,NIGHT // 12*60 + 60  световой день с 2.30 утра до 13:30 дня,   всего 12 часов из низ 1 утровечер, ост 11 день
...
void setup() {
 ...
 // time.settime(0, 01, 12, 02, 8+1, 22); //settime( СЕК [, МИН [, ЧАС [, ДЕНЬ [, МЕС [, ГОД [, ДН ]]]]]] ); 
 }
